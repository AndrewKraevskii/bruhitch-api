...
callback.post(
  ...
  handleErrorAsync(async (req, res) => {
    ...
    if (data.subscription.type !== EventSubType.Follow)
    ...
    switch (type) {
      ...
      case EventSubCallbackType.Verification: {
        ...
        //#region Send Verification CallbackResponseMessageType.VerificationFollow
        wsClient.ws.send(
          getResponseMessage(CallbackResponseMessageType.VerificationFollow, undefined)
        );
        //#endregion
